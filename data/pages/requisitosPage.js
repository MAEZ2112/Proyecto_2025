export const requisitosPage = {
    recursos: [
        {
            pdf_ruta: new URL('/recursos/requisitos/INFORMACIÓN AD-PERPETUAM.pdf', import.meta.url).pathname,
    ...
    documentos_importantes: [
        {
            img: "/img/actas_notariales.png",
            alt: "Documento 1",
            titulo: "Formato de Autentica",
            texto: "La autenticación de documentos es un proceso que se realiza para garantizar que la información que contienen es válida y auténtica.",
            url: "/recursos/AUTENTICA DE COPIAS TEGUCIGALPA.docx",
            download: "Formato de Autenticas"
        },

        {
            img: "/img/Donaciones.jpg",
            alt: "Documento 2",
            titulo: "Formato de Traspaso Vehicular",
            texto: "El formato de traspaso vehicular es un documento que se utiliza para solicitar a la autoridad competente el cambio de propietario de un vehículo",
            url: "/recursos/AUTENTICA DE FIRMA TRASPASO VEHICULO MARLEN RIVAS.docx",
            download: "Formato de Traspaso Vehicular"
        },

        {
            img: "/img/garantias_constitucionales.jpg",
            alt: "Documento 3",
            titulo: "Formato de Poderes",
            texto: "El formato de poder para pleitos y gestiones administrativas sirve para designar a una persona para que represente a otra en un procedimiento judicial o para administrar sus bienes e intereses",
            url: "/recursos/PODER PARA PLEITOS Y GESTIONES ADMINISTRATIVAS EDWIN ESPINAL.docx",
            download: "Formato de Pleito y Gestiones Administrativas"
        }
    ]
}
